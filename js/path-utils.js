...
// Choice labels (by prefix) that act as a "none of the above, go back to the
// main key" bypass for an unresolved species group. Populate this once
// data/tree.json defines such a bypass choice for Allotinus.
